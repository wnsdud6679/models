...
BASE_IMAGE_URL="http://images.cocodataset.org/zips/train2017.zip"
...
download_and_unzip ${VAL_IMAGE_URL} ${VAL_IMAGE_FILE}
VAL_IMAGE_DIR="${SCRATCH_DIR}/val2017"

# Download the captions.
#BASE_CAPTIONS_URL="http://msvocds.blob.core.windows.net/annotations-1-0-3"
BASE_CAPTIONS_URL="http://images.cocodataset.org/annotations/annotations_trainval2017.zip"
